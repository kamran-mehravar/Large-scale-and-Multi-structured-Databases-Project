...
import static it.unipi.dii.lsdb.Mehravar.AdminMenu.*;
...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // "?retryWrites=true&w=majority&wtimeout=10000" ); //clusters
        ...
        db.getCollection("cars").createIndex(new Document().append("phone", 1));
        Main main = new Main();
