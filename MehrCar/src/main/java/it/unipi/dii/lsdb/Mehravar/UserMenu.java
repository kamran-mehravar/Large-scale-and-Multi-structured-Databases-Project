...
public class UserMenu {
    ...
    public Car carInterface(String phone) {
        Car car = new Car();
    ...
    public Car insertNewCar(String phone) {
        Car car = carInterface(phone);
        CarDA carDA = new CarDA();
        ...
        try {
            ...
            Consumer<Document> processBlock = new Consumer<Document>() {
                ...
                public void accept(Document document) {
                    ...
                    System.out.println("Price: " + ((Document) document.get("car")).getString("price"));
            ...
            case "Y":
                ...
                switch (field) {
                    case "A":
                        ...
                        advertDA.updateAdvertByCarID(carID, newValue, null);
                    ...
                    case "B":
                        ...
                        newValue = UserMenu.Read();
                        advertDA.updateAdvertByCarID(carID, null, newValue);
                        System.out.println("Changes applied successfully!");
                        break;
                }
